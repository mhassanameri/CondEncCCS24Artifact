...
\hspace{-.15\textwidth}\ffigbox[\FBwidth]{\caption{CDec Time for HamDist}
  ...
  \resizebox{6cm}{!}{\begin{tikzpicture}
		...
		%\pgfplotstableread[col sep= space]{../../test/CondEnc/HDdataL8_T.dat}{\table}
		%\addplot[red, mark = *] table [x = {T}, y = {CondDec}] {\table};
		
		\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL_T1.dat}{\table}
		\addplot[red, mark = square*] table [x = {L}, y = {CondDec}] {\table};
		\label{T1}
  
        \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL_T1.dat}{\table}
		\addplot[blue, mark = square*] table [x = {L}, y = {CondDec}] {\table};
		\label{OPTT1}
		
		\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL_T2.dat}{\table}
		\addplot[red, mark = triangle*] table [x = {L}, y = {CondDec}] {\table};
		\label{T2}

        \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL_T2.dat}{\table}
		\addplot[blue, mark = triangle*] table [x = {L}, y = {CondDec}] {\table};
		\label{OPTT2}
		
		\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL_T3.dat}{\table}
		\addplot[red, mark = *] table [x = {L}, y = {CondDec}] {\table};
		\label{T3}

        \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL_T3.dat}{\table}
		\addplot[blue, mark = *] table [x = {L}, y = {CondDec}] {\table};
		\label{OPTT3}
		
		\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL_T4.dat}{\table}
		\addplot[red, mark = square*,  mark options={fill=white} ] table [x = {L}, y = {CondDec}] {\table};
		\label{T4}

        \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL_T4.dat}{\table}
...
\ffigbox[\FBwidth]{\caption{CDec Time for HamDist}\figlab{fig:HDdifL}\label{CondDecHD_T}}
  ...
  \resizebox{6cm}{!}{\begin{tikzpicture}
    ...
    \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL8_T.dat}{\table}
	\addplot[blue, mark = *] table [x = {T}, y = {CondDec}] {\table};
	\label{OPTL8}
	
	\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL16_T.dat}{\table}
	\addplot[red, mark = square*] table [x = {T}, y = {CondDec}] {\table};
	\label{L16}
 
 \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL16_T.dat}{\table}
	\addplot[blue, mark = square*] table [x = {T}, y = {CondDec}] {\table};
	\label{OPTL16}
	
	\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL32_T.dat}{\table}
	\addplot[red, mark = triangle*] table [x = {T}, y = {CondDec}] {\table};
	\label{L32}

    \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL32_T.dat}{\table}
	\addplot[blue, mark = triangle*] table [x = {T}, y = {CondDec}] {\table};
	\label{OPTL32}
 
	
	\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL64_T.dat}{\table}
	\addplot[red, mark = *] table [x = {T}, y = {CondDec}] {\table};
	\label{L64}

    \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL64_T.dat}{\table}
	\addplot[blue, mark = *] table [x = {T}, y = {CondDec}] {\table};
	\label{OPTL64}
	
	\pgfplotstableread[col sep= space]{../test/CondEnc/HDdataL128_T.dat}{\table}
	\addplot[red, mark = square*,  mark options={fill=white} ] table [x = {T}, y = {CondDec}] {\table};
	\label{L128}

    \pgfplotstableread[col sep= space]{../test/CondEnc/OPT_HDdataL128_T.dat}{\table}
...
\begin{tikzpicture}
	...
	\pgfplotstableread[col sep= space]{../test/CondEnc/EDOnedataL.dat}{\table}
	\addplot[red, mark = square*] table [x = {L}, y = {Enc}] {\table};
	\label{TradEnc}
	\pgfplotstableread[col sep= space]{../test/CondEnc/EDOnedataL.dat}{\table}
...
\begin{tikzpicture}
	...
	\pgfplotstableread[col sep= space]{../test/CondEnc/CAPSLKdataL.dat}{\table}
	\addplot[red, mark = square*] table [x = {L}, y = {Enc}] {\table};
	\label{TradEncCAPS}
...
\begin{tikzpicture}
	...
	\pgfplotstableread[col sep= space]{../test/CondEnc/ORdataL.dat}{\table}
	\addplot[red, mark = square*] table [x = {L}, y = {Enc}] {\table};
	\label{TradEncOR}
...
\begin{tikzpicture}
	...
	\pgfplotstableread[col sep= space]{../test/CondEnc/AllCtxtSize.dat}{\table}
