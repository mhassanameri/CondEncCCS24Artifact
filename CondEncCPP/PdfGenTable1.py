...
# Read the .dat file
file_path = 'Table1.dat'  # Update this with the actual path to the .dat file
...
pdf_file = 'output_table_Table1CondEncEval.pdf'
...
print(f"Table 1 which describes performance evaluation of CondEnc associate with different Predicates is saved as {pdf_file}")