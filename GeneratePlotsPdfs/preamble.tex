...
\def \ValidLginQ {\mdef{\mathtt{ValidLoginQuery}}}
...
\def \fpake {\mdef{\mathsf{fPAKE}}}
\def \view {\mdef{\mathtt{View}}}
\def \ideal {\mdef{\mathsf{Ideal}}}
\def \real {\mdef{\mathsf{Real}}}
