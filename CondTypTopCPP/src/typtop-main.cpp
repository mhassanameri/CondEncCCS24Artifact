...
//static condtyptop& user_db(const string& user) {
//    static condtyptop tp(USERDB_LOC + user);
...
int main(int argc, char *argv[])  {
     ...
     */
    if(argc<2) {
        cerr << "Typtop (" << condtyptop_VERSION_MAJOR << "." << condtyptop_VERSION_MINOR << ")";
#ifdef DEBUG
